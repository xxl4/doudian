...
class autoload
{
	...
	public static function loadClass($class)
	{
		...
		$filename = $rootPath."/open/api/afterSale_buyerExchange/".$class.".php";
		if(is_file($filename)) {
			include $filename;
			return;
		}
		$filename = $rootPath."/open/api/afterSale_buyerExchange/param/".$class.".php";
		if(is_file($filename)) {
			include $filename;
			return;
		}
		...
		$filename = $rootPath."/open/api/afterSale_buyerExchangeConfirm/".$class.".php";
		if(is_file($filename)) {
			include $filename;
			return;
		}
		$filename = $rootPath."/open/api/afterSale_buyerExchangeConfirm/param/".$class.".php";
		if(is_file($filename)) {
			include $filename;
			return;
		}
